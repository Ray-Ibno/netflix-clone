  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative">
            ...
            <video
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z0"
              playsInline
              autoPlay
              muted
              loop
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
                <img
                  ...
                  alt="Stranger Things small image"
                  className="h-full"
                />
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
          <div className="flex-1">
            <img src="kids.png" alt="Kids image" className="mt-2" />
          </div>
